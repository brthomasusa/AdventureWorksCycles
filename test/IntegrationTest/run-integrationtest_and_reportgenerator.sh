...
dotnet test --no-restore --nologo -v q --filter AWC.IntegrationTest  /p:CollectCoverage=true /p:CoverletOutputFormat=cobertura /p:Include=\"[*Application*]*,[*Core*]*,[*Infrastructure*]*,[*Presentation*]*,[*Server*]*\"
