...
dotnet test --no-restore --nologo -v q --filter AWC.UnitTest  /p:CollectCoverage=true /p:CoverletOutputFormat=cobertura /p:Include=\"[*Application*]*,[*Core*]*,[*Infrastructure*]*,[*Server*]*\"
