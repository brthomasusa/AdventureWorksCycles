...
dotnet build -m
dotnet test --no-restore --no-build --nologo -v q --filter AWC.UnitTest  /p:CollectCoverage=true /p:CoverletOutputFormat=cobertura /p:Include=\"[*Application*]*,[*Core*]*,[*Infrastructure*]*,[*Presentation*]*,[*Server*]*,[*SharedKernel*]*\"
