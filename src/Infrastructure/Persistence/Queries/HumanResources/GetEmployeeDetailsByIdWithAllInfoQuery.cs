...
namespace AWC.Infrastructure.Persistence.Queries.HumanResources
{
    ...
    {
        public async static Task<Result<EmployeeDetailsResponse>> Query
        (
            int employeeId,
            DapperContext ctx,
        ...
        )
        {
            try
            {
                ...
                EmployeeDetailsResponse detail = await connection.QueryFirstOrDefaultAsync<EmployeeDetailsResponse>(sql, parameters);
