...
{
    public sealed class UpdateEmployeeCommandToEmployeeDomainModelMapper : ModelMapper<UpdateEmployeeCommand, Employee>
    {
        private readonly IMapper _mapper;
        private Employee? _employee;
        private UpdateEmployeeCommand? _command;

        public UpdateEmployeeCommandToEmployeeDomainModelMapper(IMapper mapper)
            => _mapper = mapper;

        public override Result<Employee> Map(UpdateEmployeeCommand command)
        {
